...
def random_query(dataloader, query_size: int) -> QueryBatch:
...
def query_the_oracle(device,
    ...
    if query_strategy == 'random':
        ...
        query_batch = margin_query(model, device, poolloader, query_size=query_size)
        
    elif query_strategy == 'entropy':
        query_batch = entropy_query(model, device, poolloader, query_size=query_size)
        
    elif query_strategy == 'bald':
        query_batch = BALD_query(model, device, poolloader, query_size = query_size, T = T, method = bald_method)
